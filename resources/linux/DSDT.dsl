 ...
 *
 * Disassembly of DSDT, Thu Jan 28 17:35:12 2016
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000FC4A (64586)
 *     Revision         0x02
 *     Checksum         0xD4
 *     OEM ID           "INSYDE"
 *     OEM Table ID     "INSYDE"
...
DefinitionBlock ("DSDT.aml", "DSDT", 2, "INSYDE", "INSYDE", 0x00000003)
{
    ...
    Scope (_SB)
    {
        ...
        Device (URT1)
        {
            ...
            Device (WLAN)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (RBUF) /* \_SB_.URT1.WLAN._CRS.RBUF */
                }
        ...
        Device (I2C2)
        {
                                    ...
                                    Else
                                    {
                                        If ((_T_1 == 0x04))
                                        {
                                            Return (Buffer (0x34)
                                            {
                                                ...
                                                /* 0010 */  0x01, 0x00, 0x00, 0x00, 0x1D, 0x00, 0x01, 0x00,  /* ........ */
                                                /* 0018 */  0x8E, 0x8E, 0x01, 0x00, 0x1D, 0x00, 0x01, 0x00,  /* ........ */
                                                /* 0020 */  0x80, 0x20, 0x0D, 0x00, 0x1D, 0x00, 0x01, 0x00,  /* . ...... */
                                                /* 0028 */  0xAF, 0xAF, 0x19, 0x00, 0x1D, 0x00, 0x01, 0x00,  /* ........ */
                                                /* 0030 */  0x00, 0xC8, 0x48, 0x00                           /* ..H. */
                                            })
                                        }
                                        Else
                                        {
                                            If ((_T_1 == 0x03))
                                            {
                                                Return (Buffer (0x42)
                                                {
                                                    ...
                                                    /* 0010 */  0xE4, 0x21, 0x00, 0x00, 0xB6, 0x00, 0x00, 0x00,  /* .!...... */
            ...
            Device (RTEA)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (SBUF) /* \_SB_.I2C2.RTEA._CRS.SBUF */
                }
                                ...
                                While (One)
                                {
                                    ...
                                    Else
                                    {
                                        If ((_T_1 == 0x04))
                                        {
                                            Return (Buffer (0x1C)
                                            {
                                                /* 0000 */  0x03, 0x00, 0x00, 0xCE, 0x1D, 0x00, 0x01, 0x00,  /* ........ */
                                                /* 0008 */  0x00, 0xC8, 0x48, 0x00, 0x1D, 0x00, 0x01, 0x00,  /* ..H..... */
                                                /* 0010 */  0x00, 0x00, 0x4A, 0x00, 0x40, 0x00, 0x01, 0x00,  /* ..J.@... */
                                                /* 0018 */  0x01, 0x00, 0x00, 0x00                           /* .... */
                                            })
                                        }
                                        Else
                                        {
            ...
            Device (CAM1)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    Name (SBUF, ResourceTemplate ()
                    {
                        ...
                        I2cSerialBus (0x0021, ControllerInitiated, 0x00061A80,
                            AddressingMode7Bit, "\\_SB.I2C2",
                            0x00, ResourceConsumer, ,
                            )
                    })
        ...
        Device (I2C3)
        {
            ...
            Device (ACC1)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (RBUF) /* \_SB_.I2C3.ACC1._CRS.RBUF */
                }
            ...
            Device (CMSR)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (SBUF) /* \_SB_.I2C3.CMSR._CRS.SBUF */
                }
                ...
                Method (_DSM, 4, NotSerialized)  // _DSM: Device-Specific Method
                {
                    If ((Arg0 == ToUUID ("0703c6b6-1cca-4144-9fe7-4654f53a0bd9")))
                    {
                        ...
                        If ((Arg2 == One))
                        {
                            ...
                            {
                                Return (CPM0) /* \_SB_.I2C3.CMSR.CPM0 */
                            }

                            If ((ToInteger (Arg3) == One))
                            {
                                Return (CPM1) /* \_SB_.I2C3.CMSR.CPM1 */
                            }

                            If ((ToInteger (Arg3) == 0x02))
                            {
                                Return (CPM2) /* \_SB_.I2C3.CMSR.CPM2 */
                            }

                            If ((ToInteger (Arg3) == 0x03))
                            {
                                Return (CPM3) /* \_SB_.I2C3.CMSR.CPM3 */
                            }

                            If ((ToInteger (Arg3) == 0x05))
                            {
                                Return (CPM5) /* \_SB_.I2C3.CMSR.CPM5 */
                            }
                        }
                    }
        ...
        Device (I2C4)
        {
            ...
            {
                Name (_ADR, Zero)  // _ADR: Address
                Name (_HID, "MSSL0001")  // _HID: Hardware ID
        ...
        PowerResource (P33P, 0x05, 0x0000)
        {
            ...
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                If ((^^I2C5.PMI1.AVBG == One))
                {
                    ...
                    If ((^^I2C5.PMI1.AVBL == One))
                    {
                        Return (^^I2C5.PMI1.ALD2) /* \_SB_.I2C5.PMI1.ALD2 */
                    }
                }
    ...
    OperationRegion (MDBG, SystemMemory, 0x7CC61010, 0x00001004)
        ...
        Device (BATC)
        {
            ...
            Method (CLIM, 0, NotSerialized)
            {
                ...
                If ((DATA & 0x10))
                {
                    ...
                    {
                        Local0 = (DATA & 0xE0)
                        If (((Local0 == 0xA0) || (Local0 == 0x20)))
                        {
                            ADBG ("CLIM----1")
                            Local1 = 0x02
                        }

                        If (((Local0 == 0x40) || (Local0 == 0x60)))
                        {
                            ADBG ("CLIM----2")
                            Local1 = 0x07
                        }
    ...
    Scope (_SB.I2C5)
    {
        ...
        Device (BMBT)
        {
            ...
            Name (BUVC, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 /* ... */
            })
            CreateByteField (BUVC, 0x02, BUVT)
            ...
            Method (_BIX, 0, NotSerialized)  // _BIX: Battery Information Extended
            {
                ...
                If ((^^BMDR.AVBL == One))
                {
                    ...
                    Index (BIXP, 0x02) = DSCP /* \_SB_.I2C5.BMBT.DSCP */
            ...
            Method (_BST, 0, NotSerialized)  // _BST: Battery Status
            {
                If ((^^BMDR.AVBL == One))
                {
                    ...
                    If ((MHST != One))
                    {
                        If ((MHDT & 0x80))
                        {
                            ...
                            If ((MHDT == 0x63))
                            {
                                MARU = ^^BMDR.FCCP /* \_SB_.I2C5.BMDR.FCCP */
                            }

                            Index (BSTP, 0x02) = MARU /* \_SB_.I2C5.BMBT.MARU */
                        }
                    }
                ...
                BUVC = XP33 /* \_SB_.I2C5.XP33 */
                BUVT &= 0xEF
                BUVT |= 0x80
                XP33 = BUVC /* \_SB_.I2C5.BMBT.BUVC */
